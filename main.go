...
func main() {
	...
	model.InitDB(db)
	if err := db.AutoMigrate(&model.User{}, &model.BarkToken{}, &model.Threshold{}, &model.DistanceThreshold{}, &model.DeviceOfflineConfig{}, &model.DeviceFactoryConfig{}, &model.UserDevice{}, &model.NotificationLog{}); err != nil {
